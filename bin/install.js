...
function banner() {
    ...
    console.log(`${CYAN}${BOLD}  ║         v2.0 by Dei                 ║${RESET}`);
    console.log(`${CYAN}${BOLD}  ╚══════════════════════════════════════╝${RESET}`);
    console.log('');
}
...
function install() {
    ...
    console.log(`    ${CYAN}"optimize this FiveM resource"${RESET}`);
    console.log('');
    console.log(`${BOLD}What it checks:${RESET}`);
    console.log(`  ${GREEN}Phase 1:${RESET} Security (SQLi, dupes, XSS, backdoors, NUI, state bags)`);
    console.log(`  ${GREEN}Phase 2:${RESET} Performance (threads, caching, streaming, network)`);
    console.log(`  ${GREEN}Phase 3:${RESET} Cleanup (playerDropped, onResourceStop, memory leaks)`);
    console.log(`  ${GREEN}Phase 4:${RESET} Compatibility & Manifest (ESX, QBCore, QBox, ox_lib)`);
    console.log('');
